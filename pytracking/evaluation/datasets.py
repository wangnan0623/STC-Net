...
dataset_dict = dict(
    test_subset=DatasetInfo(module=pt % "test_subset", class_name="test_subset", kwargs=dict()),
    ...
    fe108=DatasetInfo(module=pt % "fe108", class_name="FE108", kwargs=dict()),
    visevent=DatasetInfo(module=pt % "visevent", class_name="VisEvent", kwargs=dict()),
...
def load_dataset(name: str, splits = None):
    ...
    if splits is not None:
        ...
        train_list = [f.strip() for f in open('../eotb_'+splits+'.txt', 'r').readlines()]
