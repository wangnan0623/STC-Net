...
def run_tracker(tracker_name, tracker_param, run_id=None, dataset_name='fe108', sequence=None, debug=0, threads=0, epochname=None,
                visdom_info=None):
    """Run tracker on sequence or dataset.
    args:
        tracker_name: Name of tracking method.  DiMP
        tracker_param: Name of parameter file. afnet
        run_id: The run id.
