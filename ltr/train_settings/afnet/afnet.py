...
from ltr.dataset import Lasot, Got10k, TrackingNet, MSCOCOSeq, EOTB, VisEvent
...
def run(settings):
    ...
    optimizer = optim.Adam([{'params': actor.net.classifier.parameters(), 'lr': 1e-3},
                            ...
                            {'params': actor.net.feature_extractor.parameters(), 'lr': 2e-4},
                            {'params': actor.net.fusion.parameters()}],
                           lr=2e-4)
